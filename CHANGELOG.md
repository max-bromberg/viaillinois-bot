...
- How many people a room holds is no longer shown. The number in the web platform's locations table is not one anybody measured: it reads the same for very nearly every room on campus.
